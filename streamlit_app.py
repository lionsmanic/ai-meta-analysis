...
st.title("🧬 AI-Meta Analysis Pro (Compact & Fixed)")
st.markdown("### 整合 PICO、RoB 評讀、數據萃取與 **期刊級緊湊統計圖表**")
        ...
        for i in self.df.index:
            try:
                ...
                influence_data.append({
                    ...
                    'TE': self.df.loc[i, 'TE'], # 關鍵：加入原始 TE 避免 KeyError
